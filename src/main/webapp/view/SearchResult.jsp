                ...
                <div class="row xe" id="xe">
                    ...
                    <div class="col-md-6 ftco-animate">
                        <div class="text text-center">
                            <h3>Tân Quang Dũng <span class="rating">4.0<span class="icon-star"></span></span></h3>
                            <p class="mota-xe">
                                Giường nằm - <span class="price"> 42 chỗ </span> - <span>Khăn ướt, điều hòa</span>
                            </p>
                        </div>
                        ...
                        <div class="ttct"> Thông tin chi tiết <span class="ion-ios-arrow-dropdown"></span></div>
                    </div>
                    <div class="col-md-3 ftco-animate dsLoTrinh">
                        <div class="giaVe text-center">300000Đ</div>
                        <p class="choTrong  text-center">02 chỗ trống</p>
                        <button class="btn btn-black btn-chonCho" onclick="openModal()">CHỌN CHỖ</button>
                    </div>
                    <p class="thuocchuyen"><span>*</span> Vé chặng thuộc chuyến 23:10 18-06-2023 Hà Nội - Vinh - Xuân Hội</p>
                </div>
            </div>
        </div>
    </div>
